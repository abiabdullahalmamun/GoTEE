...
@section('content')
    <div class="mx-auto">
        <x-page-header title="Biometric Scan" />
        @if (session('success'))
...
<div class="flex justify-between items-center mb-4">
    ...
    <div class="flex items-center space-x-2">
        <label for="remarks" class="text-red-600"><i>Type remarks before scan (if any)</i></label>
    ...
    <!-- Label on Right -->
    <div>
        <label for="total" class="text-gray-700"><i>Total Biometric:</i></label>
...
@push('scripts')
    @vite(['resources/js/scripts/biometric.js'])
