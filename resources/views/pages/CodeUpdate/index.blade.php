...
@section('content')
    <div class="mx-auto">
        <x-page-header title="Code Management" />
        @if (session('success'))
...
<div class="flex justify-between items-center mb-4">
    ...
    <div class="flex items-center space-x-2">
        <label for="web" class="text-gray-700"><i>Code/Webfile:</i></label>
        <input type="text" id="web" name="web" class="form-control px-3 py-2 border rounded w-64" >
    </div>

    <!-- Label on Right -->
    <div>
        <label for="total" class="text-gray-700"><i>Total Code:</i></label>
...
@push('scripts')
    @vite(['resources/js/scripts/codeUpdate.js'])
