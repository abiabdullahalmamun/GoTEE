                    ...
                    <table class="w-full border border-gray-200 text-sm">
                        <thead class="bg-gray-100">
                            <tr>
                                ...
                                <th class="border px-4 py-2 text-left">Counter Number</th>
								<th class="border px-4 py-2 text-left">Counter Name</th>
                        ...
                        <tbody id="datatable">
                            @forelse ($query as $key => $data)
                                <tr
                                    ...
                                    <td class="border px-4 py-2">{{ $data->region_id }}</td>
                                    <td class="border px-4 py-2">{{ $data->center_id }}</td>
                                    <td class="border px-4 py-2">{{ $data->counter_id }}</td>
									<td class="border px-4 py-2">{{ $data->counter_name }}</td>
