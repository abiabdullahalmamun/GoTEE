...
@section('content')
    <div class="mx-auto">
        <x-page-header title="Digitization Document Receive Scan" />
        @if (session('success'))
...
<div class="flex justify-between items-center mb-4">
    ...
    <!-- Label on Right -->
    <div>
        <label for="total" class="text-gray-700"><i>Total Scan:</i></label>
...
@push('scripts')
    @vite(['resources/js/scripts/digitizationScan.js'])
