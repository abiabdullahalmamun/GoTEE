<form method="POST" id="createOperatorForm" action="{{ route('operators.store') }}">
    @csrf
    @method('POST')
    <div class="row">
            ...
            <div class="mb-3 col-12 col-md-4 col-lg-6">
                <div class="form-group">
                    <label for="name">OperatorId</label><br><input type="text" name="emp_id"
                        class="form-control @error('emp_id') is-invalid @enderror w-full px-3 py-2 border rounded"
                        value="{{ old('emp_id') }}" placeholder="Enter OperatorId..." required>
                    @error('emp_id')
        ...
        <div class="mb-3 col-12 col-md-4 col-lg-6">
            <div class="form-group">
                <label for="name">Operator Name</label><br><input type="text" name="emp_name"
                    class="form-control @error('emp_name') is-invalid @enderror w-full px-3 py-2 border rounded"
                    value="{{ old('emp_name') }}" placeholder="Enter Operator Name..." required>
                @error('emp_name')
                    <div class="invalid-feedback">{{ $message }}</div>
                @enderror
            </div>
          ...
          <div class="mb-3 col-12 col-md-4 col-lg-6">
            <div class="form-group">
                <label for="name">CardId</label><br><input type="text" name="card_id"
                    class="form-control @error('emp_name') is-invalid @enderror w-full px-3 py-2 border rounded"
                    value="{{ old('card_id') }}" placeholder="Scan Card..." required>
                @error('card_id')
                    <div class="invalid-feedback">{{ $message }}</div>
                @enderror
            </div>
          ...
          <div class="mb-3 col-12 col-md-4 col-lg-6">
            <div class="form-group">
                <label for="name">PIN</label><br><input type="text" name="pin"
                    class="form-control @error('pin') is-invalid @enderror w-full px-3 py-2 border rounded"
                    value="{{ old('pin') }}" placeholder="Enter 4 digit pin..." required>
                @error('pin')
                    <div class="invalid-feedback">{{ $message }}</div>
                @enderror
            </div>
