     ...
     <div class="flex flex-col md:flex-row gap-4 w-full">
        <div class="flex-1">
            <label   for="name">Webfile</label><br>
             <input type="text" id="formName" name="formName" value="foreign"  required hidden>
        ...
        <div class="flex-1">
             ...
             <input  class="w-full border px-3 py-2 rounded" type="text" id="a_pass" name="a_pass" autocomplete="off" >
        </div>
    </div>
    <div class="flex flex-col md:flex-row gap-4 w-full">
        <div class="flex-1">
             <label   for="name">Name</label><br>
             <input  class="w-full border px-3 py-2 rounded" type="text" id="a_name" name="a_name" autocomplete="off" >
        </div>
    </div>
     <div class="flex flex-col md:flex-row gap-4 w-full">
          <div class="flex-1">
             <label   for="name">Contact</label><br>
             <input  class="w-full border px-3 py-2 rounded" type="text" id="a_contact" name="a_contact" autocomplete="off" >
        </div>
        <div class="flex-1">
