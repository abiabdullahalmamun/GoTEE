...
<body>
	...
	<table width=100%>
		...
		<tr>
			<td class="" colspan="2">
				<b>Name: {{$datas->ApplicantName}}</b>
			</td>
		</tr>
		
		<tr>
			<td class="" colspan="2">
				<b>Passport:{{$datas->passport}} ({{$datas->psQty}})</b>
			</td>
		</tr>
		...
		<tr>
			<td class="" colspan="2">
				<b>VisaType:{{$datas->visa->visa_type}}</b>
			</td>
		</tr>
		
		<tr>
			<td class="" colspan="2">
				<b>SMS To:{{$datas->contact}}</b>
			</td>
		</tr>
		...
		<tr>
			<td class="fee" colspan="2">
				...
				Processing Fee:{{$datas->profee}}<br>
				Special Fee:{{$datas->spfee}}<br>
				Corr Fee:{{$datas->corrFee}}<br>
				Total:{{$datas->spfee + $datas->profee}}<br>
		...
		<tr>
			<td class="" colspan="2">
				<b>{{$datas->tdd ?? 'N/A'}}   {{$datas->center->del_time ?? 'N/A'}}</b>
			</td>
		</tr>
