...
@section('content')
        ...
        <div class="bg-white shadow rounded p-6 mt-1 mx-auto">
            ...
            <div class="mt-4">
                <div id="parent-floor-list" class="floor-list overflow-y-hidden overflow-x-auto ">
                    <table  id="holidayTable" class="w-full border border-gray-200 text-sm">
    ...
    <!-- Create Menu Modal -->
    <div id="HolidayModal" class="fixed inset-0 bg-gray-800 bg-opacity-50 flex items-center justify-center hidden z-[1100]">
        <div class="bg-white p-6 rounded w-96 relative">
            <h2 class="text-lg font-bold mb-4" id="modalTitle">Create New Holiday</h2>
            @include('pages.holidays.partials.create')
        </div>
    </div>
    ...
    <div id="editModal" class="fixed inset-0 bg-gray-800 bg-opacity-50 flex items-center justify-center hidden z-[1100]">
        <div class="bg-white p-6 rounded w-96">
            <h2 class="text-lg font-bold mb-4">Edit Holiday</h2>
            @include('pages.holidays.partials.edit')
        </div>
    </div>
    ...
    <div id="viewModal" class="fixed inset-0 bg-gray-800 bg-opacity-50 flex items-center justify-center hidden z-[1100]">
        <div class="bg-white p-6 rounded w-96 relative">
            <h2 class="text-lg font-bold mb-4">View Holiday</h2>
            @include('pages.holidays.partials.view')
        </div>
    </div>
@endsection

@push('scripts')
    @vite(['resources/js/scripts/holiday.js'])
