...
@section('content')
    <div class="mx-auto">
        <x-page-header title="Activity by Operator" />
        @if (session('success'))
...
<div class="flex justify-between items-center mb-4">
    ...
    <div class="flex items-center space-x-2">
        ...
        <select class="form-control w-full px-3 py-2 border" name="actId" required="required" id="actId">
           ...
           <option value="11">Biometric</option>
           <option value="10">Form Fill-Up.</option>
           <option value="20">ForeignPassport</option>
...
@push('scripts')
    @vite(['resources/js/scripts/readyDelAct.js'])
