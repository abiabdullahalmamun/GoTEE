<form method="POST" id="createRejectForm" action="{{ route('regions.store') }}">
    @csrf
    @method('POST')
    <div class="row">
        <div class="mb-3 col-12 col-md-4 col-lg-6">
            <div class="form-group">
                <label for="name">Name</label><br><input type="text" name="region_name"
                    class="form-control @error('region_name') is-invalid @enderror w-full px-3 py-2 border rounded"
                    value="{{ old('region_name') }}" placeholder="Enter Name..." required>
                @error('region_name')
        ...
        <div class="mb-3 col-12 col-md-4 col-lg-6">
            <div class="form-group">
              ...
              <input type="text" name="region_text"
