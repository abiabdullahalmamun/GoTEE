...
@section('content')
    <div class="mx-auto">
        <x-page-header title="Passport Delivery" />
        @if (session('success'))
...
<div class="w-full px-4">
    <div class="flex justify-between items-center mb-4 w-full">
        ...
        <!-- Second Input -->
        <div class="flex items-center space-x-2">
            <label for="remarks" class="text-blue-700"><i>Type remarks before scan (if any)</i></label>
            <input type="text" id="remarks" name="remarks"
                   class="form-control px-3 py-2 border rounded w-64"
                   placeholder="GD Copy here...">
        </div>

        <!-- Label on Right -->
        <div>
            <label for="total" class="text-gray-700"><i>Total Delivery:</i></label>
...
@push('scripts')
    @vite(['resources/js/scripts/centerDelivery.js'])
