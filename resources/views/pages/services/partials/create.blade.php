<form method="POST" id="createShopForm" action="{{ route('services.store') }}">
    @csrf
    @method('POST')
    <div class="row">
        <div class="mb-3 col-12 col-md-4 col-lg-6">
            <div class="form-group">
                <label for="name">Name</label><br><input type="text" name="svcName"
        ...
        <div class="mb-3 col-12 col-md-4 col-lg-6">
            <div class="form-group">
                <label for="name">Default Sec</label><br><input type="number" name="defsec"
                    class="form-control @error('name') is-invalid @enderror w-full px-3 py-2 border rounded"
            ...
            <div class="flex items-center space-x-3">
                <label class="inline-flex items-center">
                    <input type="radio" name="type" value="0"
                        class="form-radio text-green-600 focus:ring-green-500 @error('type') border-red-500 @enderror"
                        checked>
                ...
                <label class="inline-flex items-center">
                    <input type="radio" name="type" value="1"
                        class="form-radio text-red-600 focus:ring-red-500 @error('type') border-red-500 @enderror">
