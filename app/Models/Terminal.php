...
class Terminal extends Model
{
    ...
    protected $fillable = ['company_id', 'devID', 'devType', 'ip','mac','status','created_by','location','ssid','passkey','message','shopId','loginId'];
    ...
    {
        return $this->belongsTo(Employee::class, 'loginId');
    }
    /**
     * Get the parent menu.
     */
