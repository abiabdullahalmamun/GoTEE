...
class StickerPrintLog extends Model
{
    use Loggable;
    use HasFactory;

    protected $table = 'tbl_barcode_print_log';
    protected $fillable = ['Date', 'stickerId', 'centerId', 'startNo', 'endNo','created_by'];
    ...
    {
        return $this->belongsTo(StickerMap::class, 'stickerId');
    }
