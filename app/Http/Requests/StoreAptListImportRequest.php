...
class StoreAptListImportRequest  extends FormRequest
{
    /**
    ...
    public function rules()
    {
        return [
            ...
            'import_file' => 'required|file|mimes:txt|max:51200',
    ...
    {
        return [
            'regionId.required' => 'The regionId is required.',
            'import_file.required' => 'The import file is required.',
            'import_file.mimes' => 'Only .txt files are allowed.',
            'import_file.max' => 'The import file can not be greater than 50MB.',
        ];
    }
