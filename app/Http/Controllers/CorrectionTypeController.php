...
use App\Http\Requests\StoreCorrectionTypeRequest;
use App\Http\Requests\UpdateCorrectionTypeRequest;
...
class CorrectionTypeController extends Controller
{
    /**
    ...
    public function index(Request $request): View
    {
        ...
        try {
            ...
            $query = CorrectionType::query()->latest('id');
            ...
            return view('pages.correction_types.index', with(['query' => $query]));
