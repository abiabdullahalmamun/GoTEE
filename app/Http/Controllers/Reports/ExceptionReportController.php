    ...
    public function index(Request $request): View 
    {
        ...
        // Filters
            ...
            $users = User::select('id', 'name', 'email')
             ...
             $modules = ActionExcept::select('module')
                        ->distinct()
                        ->orderBy('module', 'asc')
                        ->get();
            
            return view('reports.exception_reports.index', compact('data', 'centers', 'users','cenId','role', 'modules'));
           
        } catch (Exception $e) {
             $mess = $e->getMessage(); 
             dd($mess) ; 
               return view('reports.exception_reports.index', [
                    'data' => collect(),
                    'centers' => collect(),
                    'users' => collect(),
                    'cenId' => null,
