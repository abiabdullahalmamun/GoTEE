...
class RejectPrintExport implements FromCollection, WithHeadings, WithEvents
{
    protected $request;
    ...
    public function collection()
    {
        ...
        return $query->with(['center', 'user','rejectReasons' ])->get()->map(function ($row, $index) {
             return [
                 $index + 1,
    ...
    {
        return [
           'SL','Center', 'Date', 'Webfile', 'Name','passport', 'Contact','VisaType','Reasons' , 'CreatedBy', 'CreatedAt'
        ];
    }
    ...
    public function registerEvents(): array
    {
        return [
            AfterSheet::class => function (AfterSheet $event) {
                ...
                $event->sheet->setCellValue('A1', 'Reject Report');
