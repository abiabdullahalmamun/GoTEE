...
class BiometricPrintExport implements FromCollection, WithHeadings, WithEvents
{
    protected $request;
    ...
    public function collection()
    {
        ...
        return $query->with(['center', 'webref','user'])->where('stepId',11)->get()->map(function ($row, $index) {
             return [
                 $index + 1,
    ...
    public function registerEvents(): array
    {
        return [
            AfterSheet::class => function (AfterSheet $event) {
                ...
                $event->sheet->setCellValue('A1', 'Biometric Scan Report');
