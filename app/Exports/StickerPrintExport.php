...
class StickerPrintExport implements FromCollection, WithHeadings, WithEvents
{
    protected $request;
    ...
    public function collection()
    {
        ...
        return $query->with(['center', 'user'])->get()->map(function ($row) {
            return [
    ...
    {
        return [
           'Center', 'Date', 'StickerType', 'StartNo','EndNo', 'Printed By', 'Printed At'
        ];
    }
    ...
    public function registerEvents(): array
    {
        return [
            AfterSheet::class => function (AfterSheet $event) {
                ...
                $event->sheet->setCellValue('A1', 'Barcode Sticker print Report');
