...
class Rec4mhciPrintExport implements FromCollection, WithHeadings, WithEvents
{
    protected $request;
    ...
    public function collection()
    {
        ...
        return $query->with(['center', 'webref','user'])->whereIn('stepId',[31,32,33])->get()->map(function ($row) {
             return [
    ...
    {
        return [
           'Center', 'Date', 'Webfile', 'Name','passport', 'Contact','VisaType','SticketType','StickerNo' ,'CreatedBy', 'CreatedAt'
        ];
    }
    ...
    public function registerEvents(): array
    {
        return [
            AfterSheet::class => function (AfterSheet $event) {
                ...
                $event->sheet->setCellValue('A1', 'Receive From HCI Report');
