...
class FormFillPrintExport implements FromCollection, WithHeadings, WithEvents
{
    protected $request;
    ...
    {
        return [
           'SL','Center', 'Date', 'Webfile', 'Name','passport', 'Contact','Remarks','fee' , 'CreatedBy', 'CreatedAt'
        ];
    }
    ...
    public function registerEvents(): array
    {
        return [
            AfterSheet::class => function (AfterSheet $event) {
                ...
                $event->sheet->setCellValue('A1', 'Form Fill-in Report');
